...
public class ScreenshotUtility implements ITestListener{	
	...
	public void onTestSuccess(ITestResult tr) {
		...
		if(System.getProperty("screenShotOnPass").equalsIgnoreCase("yes"))
		{
	...
	public void onTestFailure(ITestResult tr) {		
		...
		if(System.getProperty("screenShotOnFail").equalsIgnoreCase("yes"))
		{
	...
	public void captureScreenShot(ITestResult result, String status){	
		...
		File scrFile = ((TakesScreenshot) base.SeleniumDriver.driver).getScreenshotAs(OutputType.FILE);
