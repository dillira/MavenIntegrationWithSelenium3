...
public class CostingApprovalWF extends TestsuiteBase{
		...
		public static By cellUnitPrice = By.id("r1_hbUnitPrice");
		public static By inputUnitPrice = By.xpath("//div[@id='hbUnitPriceSourceDiv']/input");
		
		public static By cellUsagePerK = By.id("r1_hbUsagePerK");
		...
		public static String copyLinkProduct(String[] data) {
			try{
				//Select 'Season'
				CommonFunctions.selectFromDropDownByVisibleText(SmokeFlow.seasonDD, data[5]);
				//Select ' Product Type'
				CommonFunctions.selectFromDropDownByVisibleText(SmokeFlow.productType,data[11]);
				//Select 'Relationship Type'
				CommonFunctions.selectFromDropDownByVisibleText(SmokeFlow.relationShipType, data[12]);
	...
	//Update specification to 'Supplier released' state
		...
		public void reporterdataSetResult(){
			if(skip)
				Utility.dataSetResult(suiteWFTestXls, this.getClass().getSimpleName(), count+2, "SKIP");
			else if(fail){
				Utility.dataSetResult(suiteWFTestXls, this.getClass().getSimpleName(), count+2, "FAIL");
				isTestPass=false;
			}
			else
				Utility.dataSetResult(suiteWFTestXls, this.getClass().getSimpleName(), count+2, "PASS");
			skip=false;
			fail=false;
		}
		@BeforeTest
		public void checkTestcaseSkip() throws Exception{
			...
			if(!Utility.isCaseRunnable(suiteWFTestXls, this.getClass().getSimpleName())){
				log.debug("Skipping "+this.getClass().getSimpleName()+" as runmode is set to no");
				throw new SkipException("Skipping "+this.getClass().getSimpleName()+" as runmode is set to no");
			}
			runmodes=Utility.getDataSetRunmodeTest(suiteWFTestXls, this.getClass().getSimpleName());
		}
		@AfterTest
		public void reportTestcaseResult(){
			if(isTestPass){
				Utility.dataSetResult(suiteWFTestXls,"Testcases", Utility.getRowNum(suiteWFTestXls, this.getClass().getSimpleName()),"PASS");
			}else
				Utility.dataSetResult(suiteWFTestXls,"Testcases", Utility.getRowNum(suiteWFTestXls, this.getClass().getSimpleName()),"FAIL");

		}

		@DataProvider
		public Object[][] testDataTest(){
			return Utility.getData(suiteWFTestXls, this.getClass().getSimpleName());
		}
